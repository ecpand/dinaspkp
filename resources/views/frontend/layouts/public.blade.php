...
<head>
    ...
    <link rel="icon" type="{{ str_ends_with(strtolower((string) $setting?->favicon_path), '.ico') ? 'image/x-icon' : 'image/png' }}" href="{{ $setting?->favicon_path ? asset('storage/'.$setting->favicon_path) : asset('assets/img/logo.png') }}">
