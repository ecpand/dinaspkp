        ...
        <form class="public-rlth-form" method="POST" action="{{ route('public.rlth.store') }}" enctype="multipart/form-data" novalidate>
            ...
            <section class="public-rlth-section">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6"><label class="form-label">Nomor Kartu Keluarga <b>*</b></label><input name="family_card_number" inputmode="numeric" maxlength="32" class="form-control @error('family_card_number') is-invalid @enderror" value="{{ old('family_card_number') }}" required placeholder="Nomor KK"></div>
